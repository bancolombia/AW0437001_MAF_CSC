<%@ Page Title="Calificación de Cliente" Language="C#" MasterPageFile="~/CalificacionCartera/Master/General.Master"
    AutoEventWireup="true" CodeBehind="CalificacionClienteGob.aspx.cs" Inherits="Bancolombia.Riesgo.MAFWeb.CalificacionCartera.CalificacionClienteGob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        /*Funcion que valida si se elegio una de las siguientes opciones y valida la longitud del campo txtComentariosRiesgos
        Recomendación AEC (DataList ddlRecomendacion)
        Segumiento Proximo Comité (DataList ddlSeguimiento)
        */
            ...
            <asp:Panel ID="pnlCliente" runat="server" Visible="False">
                ...
                <asp:Panel ID="pnlCalificacionComercial" runat="server">
                    <table class="lblNormal" border="0" width="100%">
                        ...
                        <tr class="lblNormal">
                            ...
                            <!--
                             <td class="lblSubTitInfo">
                              ...
                              <td class="lblNormal">
                                    <asp:Label ID="lblCalifRecomenGrupoCom" runat="server"></asp:Label>
                              </td> !-->
                            <td>
                                &nbsp;
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="lblNormal">
                                <asp:Label ID="lblCalMAFNuevoRatingCom" runat="server"></asp:Label>
                            </td> !-->
                            <td class="lblNormal">
                                &nbsp;
                            </td>
                    ...
                    <table class="lblNormal" border="0" width="100%">
                        ...
                        <tr class="lblNormal">
                            ...
                            <tr class="lblNormal">
                                ...
                                <td class="lblNormal">
                                    <!-- <asp:DropDownList ID="ddlRazon1" runat="server" CssClass="listCampo">
                                    </asp:DropDownList> -->
                ...
                <asp:Panel ID="pnlComentarios" runat="server">
                    <table class="lblNormal" border="0" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                                <td align="center" align="center" class="lblErrorBoldPreguntas">
                                    Calificación para Gobierno (municipios y departamentos)
                                </td>
                            </tr>
                        <tr>
                            <td class="lblNormal" colspan="2">
                        ...
                        <tr>
                            <td class="lblSubTitInfo">
                            <asp:Label ID="lblPregunta19" runat="server" CssClass="lblSubTitInfo"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblDescripcion" colspan="2">
                            <asp:Label ID="lblComplementoPregunta19" runat="server"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblNormal" colspan="2">
                                <asp:TextBox ID="txtRespuestaPregunta19" runat="server" Height="50px" Width="96%" CssClass="txtCampo117" 
                                onkeyup="Count(this,500)" MaxLength="500" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                         <tr>
                            <td class="lblSubTitInfo">
                                <asp:Label ID="lblPregunta20" runat="server" CssClass="lblSubTitInfo"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblDescripcion" colspan="2">
                            <asp:Label ID="lblComplementoPregunta20" runat="server"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblNormal" colspan="2">
                                <asp:TextBox ID="txtRespuestaPregunta20" runat="server" Height="50px" Width="96%" CssClass="txtCampo117" 
                                onkeyup="Count(this,500)" MaxLength="500" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                         <tr> 
                            <td class="lblSubTitInfo">
                                <asp:Label ID="lblPregunta21" runat="server" CssClass="lblSubTitInfo"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblDescripcion" colspan="2">
                            <asp:Label ID="lblComplementoPregunta21" runat="server"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblNormal" colspan="2">
                                <asp:TextBox ID="txtRespuestaPregunta21" runat="server" Height="50px" Width="96%" CssClass="txtCampo117" 
                                    onkeyup="Count(this,500)" MaxLength="500" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                         <tr>
                            <td class="lblSubTitInfo">
                                <asp:Label ID="lblPregunta22" runat="server" CssClass="lblSubTitInfo"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblDescripcion" colspan="2">
                            <asp:Label ID="lblComplementoPregunta22" runat="server"> </asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="lblNormal" colspan="2">
                                <asp:TextBox ID="txtRespuestaPregunta22" runat="server" Height="50px" Width="96%" CssClass="txtCampo117" 
                                onkeyup="Count(this,500)" MaxLength="500" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                            ...
                            <asp:Panel runat="server" ID="pnlInfoNuevoComite" Width="700px">
                                <table width="100%">
                                    ...
                                    <!--<tr>
                                        ...
                                        <td class="lblNormal">
                                            <asp:Label ID="lblCANClientePerteneceIFRS" runat="server"></asp:Label>
                                        </td>
                                        <td class="lblSubTitInfo">
                                            &nbsp;
                                        </td>
