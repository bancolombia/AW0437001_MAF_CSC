...
{
    public partial class CalificacionCliente : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (((Usuario)Session["Rol"]).rol.Equals("Admin"))
            {
        ...
        protected void cmdOk_Click(object sender, EventArgs e)
        {
            ...
            Parametros[] parametros = (Parametros[])Session["parametros"];
            string respuesta = "";
            ...
            if (((Usuario)Session["Rol"]).rol.Equals("Comercial"))
            {
                ...
                if (validarPreguntas())
                {
                    ...
                    respuesta = Fachada.CalificacionCartera.ActualizarCliente(objCliente, ((Usuario)Session["Rol"]).usuario, "");
            ...
            else if (((Usuario)Session["Rol"]).rol.Equals("R"))
            {
                if (validarPreguntas())
                {
                    establecerEncodingCamposTexto();
        ...
        protected bool validarPreguntas()
        {
            ...
            {
                txtPregunta10 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.085").Texto;
                contadorTxt = contadorTxt + 1;
            }
            if (ddlPregunta11.SelectedValue.Trim().Equals("0"))
            {
                pregunta11 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.086").Texto;
                contador = contador + 1;
            }
            if (txtRespuestaPregunta11.Text.Trim().Equals(string.Empty) && (ddlPregunta11.SelectedValue.Trim().Equals("SI")))
            {
                txtPregunta11 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.086").Texto;
                contadorTxt = contadorTxt + 1;
            }
            if (ddlPregunta12.SelectedValue.Trim().Equals("0"))
            {
                pregunta12 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0487").Texto;
                contador = contador + 1;
            }
            if (txtRespuestaPregunta12.Text.Trim().Equals(string.Empty) && (ddlPregunta12.SelectedValue.Trim().Equals("SI")))
            {
                txtPregunta12 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0487").Texto;
                contadorTxt = contadorTxt + 1;
            }
            if (ddlPregunta13.SelectedValue.Trim().Equals("0"))
            {
                pregunta13 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0488").Texto;
                contador = contador + 1;
            }
            if (txtRespuestaPregunta13.Text.Trim().Equals(string.Empty) && (ddlPregunta13.SelectedValue.Trim().Equals("SI")))
            {
                txtPregunta13 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0488").Texto;
                contadorTxt = contadorTxt + 1;
            }
            if (ddlPregunta14.SelectedValue.Trim().Equals("0"))
            {
                pregunta14 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0489").Texto;
                contador = contador + 1;
            }
            if (txtRespuestaPregunta14.Text.Trim().Equals(string.Empty) && (ddlPregunta14.SelectedValue.Trim().Equals("SI")))
            {
                txtPregunta14 = Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0489").Texto;
                contadorTxt = contadorTxt + 1;
            }
            ////Única validación para todos los controles
            ///
            ...
            if ((pregunta1 != "") || (pregunta2 != "") || (pregunta3 != "") || (pregunta4 != "") || (pregunta5 != "") || (pregunta6 != "") || (pregunta7 != "") || (pregunta8 != "") || (pregunta9 != ""))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardarComercial", "javascript:alert('" +
                    Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0491").Texto + Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0492").Texto +
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardarComercial", "javascript:alert('" +
                    Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0494").Texto + Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0492").Texto +
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardarComercial", "javascript:alert('" +
                    Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0491").Texto + Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0493").Texto +
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardarComercial", "javascript:alert('" +
                    Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0494").Texto + Mensajes.Mensajes.ObtenerMensaje("MAF", "MEN.0493").Texto +
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    IEnumerable<Parametros> listaNuevoRating = param.Where(p => p.paramName.Trim().Equals("LLNR"));
            ...
            try
            {
                ...
                if (objCalificacion.setDatos != null && objCalificacion.objCliente != null)
                {
                    ...
                    else if (((Usuario)Session["Rol"]).rol.Equals("Riesgos - PIC"))
                    {
                        ...
                        ddlCalifExternaP.DataTextField = "APCVALC";
                        ddlCalifExternaP.DataValueField = "APCVALC";
                        ...
                        ddlRazon.DataTextField = "APCVALC";
                        ddlRazon.DataValueField = "APCVALC";
                        ddlRazon.DataBind();
                        ...
                        ddlTipoCliente.DataTextField = "APCVALC";
                        ddlTipoCliente.DataValueField = "APCVALC";
                        ...
                        ddlUtilizoEEFF.DataTextField = "APCVALC";
                        ddlUtilizoEEFF.DataValueField = "APCVALC";
                        ...
                        ddlSeguimiento.DataTextField = "APCVALC";
                        ddlSeguimiento.DataValueField = "APCVALC";
                        ...
                        ddlRecomendacion.DataTextField = "APCVALC";
                        ddlRecomendacion.DataValueField = "APCVALC";
                        ...
                        ddlEstadoCal.DataTextField = "APCVALC";
                        ddlEstadoCal.DataValueField = "APCVALC";
        ...
        //Implementación Nit de relacionamiento 
