...
namespace Bancolombia.Riesgo.MAFWeb.CalificacionCartera.Reporte
{
    public partial class PDF : System.Web.UI.Page
    {
                ...
                else
                {
                    try
                    {
                        if (Request.QueryString["Prdo"] == null)
                        {
                            ...
                            string catCliente = Request.QueryString["categoriaCliente"].ToString();
                            ...
                            HTMLToPdf(HTMLRoles(cl, catCliente).ToString());
                        }
                        else
                        {
                            string cliente = Request.QueryString["cliente"].ToString();
                            ...
                            Cliente cl = new Cliente();
                            string rol = string.Empty;
                            if (((Usuario)Session["Rol"]).rol.Equals("Comercial") || ((Usuario)Session["Rol"]).rol.Equals("Consulta"))
                            {
                            ...
                            HTMLToPdf(HTMLRolesHis(cl, catCliente).ToString());
                        }
                    }
                    catch (Exception ex)
                    {
        ...
        /// <returns></returns>
        protected StringBuilder HTMLRoles(Cliente objCliente, string catCliente)
        {
            ...
            if (Session["Rol"] != null && !((Usuario)Session["Rol"]).rol.Equals("Comercial"))
            {
            ...
            html.AppendLine("                        " + objCliente.nit.Trim() + " ");
            html.AppendLine("                    </td> ");
            html.AppendLine("                    <td> ");
            html.AppendLine("                        Nit Relacionamiento: </td> ");
            html.AppendLine("                    <td> ");
            html.AppendLine("                        " + (!string.IsNullOrEmpty(objCliente.nitRelacion.Trim()) && (!objCliente.nit.Equals(objCliente.nitRelacion.Trim())) ? objCliente.nitRelacion.Trim(): "No tiene") + " ");
            html.AppendLine("                    </td> ");
            html.AppendLine("                    <td> ");
            html.AppendLine("                        &nbsp;</td> ");
            html.AppendLine("                </tr> ");
            ...
            informacionEndeudamiento(((Usuario)Session["Rol"]).rol, ref html, ref errores, objCliente);
            ...
            //html.AppendLine("                <tr> ");
            //html.AppendLine("                    <td style=\"border-color:black;font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
            //html.AppendLine("                    Miami</td> ");
            //html.AppendLine("                    <td style=\"border-color:black;text-align:right;font-family: Verdana; color:black;vertical-align:middle;font-size: 7px\"> ");
            //html.AppendLine("                        <label >" + objCliente.saldoKMiami.Trim() + "</label> ");
            //html.AppendLine("                    </td> ");
            //html.AppendLine("                    <td style=\"border-color:black;text-align:right;font-family: Verdana; color:black;vertical-align:middle;font-size: 7px\"> ");
            //html.AppendLine("                        <label >" + objCliente.saldoIMiami.Trim() + "</label> ");
            //html.AppendLine("                    </td> ");
            //html.AppendLine("                     ");
            //html.AppendLine("                </tr> ");
            html.AppendLine("                <tr> ");
            ...
            CalificacionesComentarios(((Usuario)Session["Rol"]).rol, ref html, ref errores, objCliente, catCliente);
        ...
        private void CalificacionesComentarios(string rol, ref StringBuilder html, ref StringBuilder errores, Cliente objCliente, string catCliente)
        {
            //string analisisPyG = "";
            ...
            string RespListaPregunta15 = "";
            string RespPregunta15 = "";

            string RespListaPregunta16 = "";
            string RespPregunta16 = "";

            string RespListaPregunta17 = "";
            string RespPregunta17 = "";

            string RespListaPregunta18 = "";
            string RespPregunta18 = "";

            string RespListaPregunta19 = "";
            string RespPregunta19 = "";

            string RespListaPregunta20 = "";
            string RespPregunta20 = "";

            string RespListaPregunta21 = "";
            string RespPregunta21 = "";

            string RespListaPregunta22 = "";
            ...
            if (rol.Equals("Comercial") && Request.QueryString["Prdo"] == null)
            {
                ...
                html.AppendLine("            </td> ");
                html.AppendLine("        </tr> ");
                // PMO27494 el campo PerteneceIFRS ya no existe
                /*html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
                html.AppendLine("                Cliente Pertenece a IFRS</td> ");
                html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
                html.AppendLine("                <label >" + objCliente.perteneceIFRS.Trim() + "</label> ");*/
                //html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
                //html.AppendLine("                Calificación Recomendada Alineación Grupo Bancolombia:</td> ");
                //html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
                ...
                html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
                html.AppendLine("                <label >" + (objCliente.ListasDeControl.Trim().Equals("0") ? "" : objCliente.ListasDeControl.Trim()) + "</label> ");
                html.AppendLine("            </td> ");
                html.AppendLine("            <td> ");
                html.AppendLine("                &nbsp;</td> ");
                html.AppendLine("            <td> ");
                ...
                //html.AppendLine("        <tr> ");
                //html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
                //html.AppendLine("                    Calificación Modelo de Rating:</td> ");
                //html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
                ...
                SustentacionCalRecCom = objCliente.SustentacionCalRecCom.Trim();
                RespListaPregunta1 = objCliente.RespListaPregunta1Com.Trim();
                RespPregunta1 = objCliente.RespPregunta1Com.Trim();
                RespListaPregunta2 = objCliente.RespListaPregunta2Com.Trim();
                RespPregunta2 = objCliente.RespPregunta2Com.Trim();
                RespListaPregunta3 = objCliente.RespListaPregunta3Com.Trim();
                RespPregunta3 = objCliente.RespPregunta3Com.Trim();
                RespListaPregunta4 = objCliente.RespListaPregunta4Com.Trim();
                RespPregunta4 = objCliente.RespPregunta4Com.Trim();
                RespListaPregunta5 = objCliente.RespListaPregunta5Com.Trim();
                RespPregunta5 = objCliente.RespPregunta5Com.Trim();
                RespListaPregunta6 = objCliente.RespListaPregunta6Com.Trim();
                RespPregunta6 = objCliente.RespPregunta6Com.Trim();
                RespListaPregunta7 = objCliente.RespListaPregunta7Com.Trim();
                RespPregunta7 = objCliente.RespPregunta7Com.Trim();
                RespListaPregunta8 = objCliente.RespListaPregunta8Com.Trim();
                RespPregunta8 = objCliente.RespPregunta8Com.Trim();
                RespListaPregunta9 = objCliente.RespListaPregunta9Com.Trim();
                RespPregunta9 = objCliente.RespPregunta9Com.Trim();
                RespListaPregunta10 = objCliente.RespListaPregunta10Com.Trim();
                RespPregunta10 = objCliente.RespPregunta10Com.Trim();
                RespListaPregunta11 = objCliente.RespListaPregunta11Com.Trim();
                RespPregunta11 = objCliente.RespPregunta11Com.Trim();
                RespListaPregunta12 = objCliente.RespListaPregunta12Com.Trim();
                RespPregunta12 = objCliente.RespPregunta12Com.Trim();
                RespListaPregunta13 = objCliente.RespListaPregunta13Com.Trim();
                RespPregunta13 = objCliente.RespPregunta13Com.Trim();
                RespListaPregunta14 = objCliente.RespListaPregunta14Com.Trim();
                RespPregunta14 = objCliente.RespPregunta14Com.Trim();

                //Nuevas modificaciones
                RespPregunta15 = objCliente.RespPregunta15Com;
                RespPregunta16 = objCliente.RespPregunta16Com;
                RespPregunta17 = objCliente.RespPregunta17Com;
                RespPregunta18 = objCliente.RespPregunta18Com;
                RespPregunta19 = objCliente.RespPregunta19Com;
                RespPregunta20 = objCliente.RespPregunta20Com;
                RespPregunta21 = objCliente.RespPregunta21Com;
                RespPregunta22 = objCliente.RespPregunta22Com;
            ...
            else
            {
                ...
                /* html.AppendLine("        <tr> ");
                 ...
                 html.AppendLine("            </td> ");
                 html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
                 html.AppendLine("                <label>" + (objCliente.calIntRat.Trim().Equals("0") ? "" : objCliente.calIntRat.Trim()) + "</label> ");
                 html.AppendLine("            </td> ");
                 html.AppendLine("        </tr> ");*/
                html.AppendLine("        <tr> ");
                html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
                ...
                html.AppendLine("        <tr> ");
                html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
                html.AppendLine("                 Calificación Recomendada PEC (Sector Financiero):</td> "); // PMO19939 - RF014: Modificar PDF Riesgos con el cambio de etiqueta “Calificación Recomendada PEC
                html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
                ...
                html.AppendLine("                El cliente se encuentra en lista de control:</td> ");
                html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
                html.AppendLine("                <label>" + (objCliente.ListasDeControl.Trim().Equals("0") ? "" : objCliente.ListasDeControl.Trim()) + "</label> </td> ");
                html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
            ...
            //    html.AppendLine("    <table style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\" border=\"0\" width=\"60%\" > ");
            ...
            //    html.AppendLine("        <tr> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
            //    html.AppendLine("                Calificación Externa Ratificada:</td> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
            //    html.AppendLine("                <label >" + (objCliente.calExtRat.Trim().Equals("0") ? "" : objCliente.calExtRat.Trim()) + "</label> ");
            //    html.AppendLine("            </td> ");
            //    html.AppendLine("        </tr> ");
            ...
            //    html.AppendLine("                Calificación Interna Actual:</td> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
            //    html.AppendLine("                <label >" + (objCliente.CalIntAct.Trim().Equals("0") ? "" : objCliente.CalIntAct.Trim()) + "</label> ");
            //    html.AppendLine("            </td> ");
            //    html.AppendLine("        </tr> ");*/
            //    html.AppendLine("        <tr> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: top;font-weight: bold\"> ");
            //    html.AppendLine("                Razón Calificación:</td> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
            //    processoRazCaliInt(objCliente.razCaliInt, ref html);
            //    html.AppendLine("            </td> ");
            //    html.AppendLine("        </tr> ");
            //  /*html.AppendLine("        <tr> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
            //    html.AppendLine("                Calificación MAF:</td> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color:black;text-align:left;vertical-align:middle\"> ");
            //    html.AppendLine("                <label >" + (objCliente.calMAF.Trim().Equals("0") ? "" : objCliente.calMAF.Trim()) + "</label> ");
            //    html.AppendLine("            </td> ");
            //    html.AppendLine("        </tr> ");*/
            //    html.AppendLine("        <tr> ");
            //    html.AppendLine("            <td style=\"font-family: Verdana;font-size: 7px;color: black;text-align: left;vertical-align: middle;font-weight: bold\"> ");
            ...
            //    analisisBalance = objCliente.analisisBalPIC.Trim();
            //    analisisPyG = objCliente.analisisPyGPIC.Trim();
            //    comentariosAdicionales = (objCliente.comAuto.Trim().Equals(string.Empty) ? objCliente.comAdPIC.Trim() : objCliente.comAuto.Trim());
            //    comentariosRiesgos = objCliente.comentarioRiesgos.Trim();
            //}
            ...
            int i = 1;
            foreach (Parametros row in Lista.Cast<Parametros>().Where(p => p.paramName.Trim().Equals("PRFORMPRE")))
            {
                if (row.paramSeq != 0)
                {
                    Parametros Coleccion1 = Lista.Cast<Parametros>().Where(p => p.paramName.Trim().Equals("PRFORMPRE") && p.paramSeq == i).ElementAt(0);

                    if (row.paramSeq > 9)
                    {
                        if ((row.paramSeq == 10) && ((catCliente == "PP") || (catCliente == "FI")))
                        {
                            html.AppendLine("        <tr> ");
                        ...
                        if ((row.paramSeq == 15) && (catCliente == "FI"))
                        {
                            html.AppendLine("        <tr> ");
                            html.AppendLine("            <td align=\"center\" style=\"font-family: Verdana;font-size: 9px;color:black;text-align: center;height: 27px;vertical-align: middle;font-weight:bold\" colspan=\"2\"> ");
                        ...
                        if ((row.paramSeq == 19) && (catCliente == "GB"))
                        {
                            html.AppendLine("        <tr> ");
                            html.AppendLine("            <td align=\"center\" style=\"font-family: Verdana;font-size: 9px;color:black;text-align: center;height: 27px;vertical-align: middle;font-weight:bold\" colspan=\"2\"> ");
                    ...
                    if ((catCliente == "PP") || (catCliente == "FI"))
                    {
                    ...
                    if ((Coleccion1.paramSeq > 14) && (Coleccion1.paramSeq <= 18) && (catCliente == "FI"))
                    {
                    ...
                    if ((Coleccion1.paramSeq > 18) && (catCliente == "GB"))
                    {
        ...
        /// <param name="errores"></param>
        /// <param name="objCliente"></param>
        private void informacionEndeudamiento(string rol, ref StringBuilder html, ref StringBuilder errores, Cliente objCliente)
        {
            if (rol.Equals("Comercial") || rol.Equals("Riesgos - PIC") || rol.Equals("Consulta") || rol.Equals("Superfinanciera"))
            {
                ...
                else
                {
                    ...
                    html.AppendLine("                <tr> ");
                    if (rol.Equals("Consulta") || rol.Equals("Superfinanciera"))
                    {
                        html.AppendLine("                    <td style=\"font-family: Verdana;font-size: 7px;color:black;font-weight: bold;text-align:left;vertical-align:middle\" > ");
                        html.AppendLine("                         &nbsp; ");
                        html.AppendLine("                    </td> ");
        ...
        private void ObtenerInformacionFinanciera(string rol, Cliente objCliente, ref StringBuilder html, ref StringBuilder errores)
        {
            ...
            if (int.TryParse(objCliente.fechaEstFros.Trim(), out fecha) && fecha.ToString().Length == 6)
            {
                ...
                html.AppendLine("            <td colspan=\"3\" style=\"font-family: Verdana;font-size: 7px;color:black;font-weight: bold;text-align:right;vertical-align:middle> ");
                ...
                if (double.TryParse(objCliente.pasivoFroCP.Trim(), NumberStyles.Float | NumberStyles.AllowParentheses | NumberStyles.AllowParentheses | NumberStyles.AllowThousands, nfi, out PasivoFCP) && double.TryParse(objCliente.pasivoFroLP, NumberStyles.Float | NumberStyles.AllowParentheses | NumberStyles.AllowParentheses | NumberStyles.AllowThousands, nfi, out PasivoFLP))
                {
                    ...
                    {
                        //string num = lblDeudaEbitda.Text.Substring(0, lblDeudaEbitda.Text.IndexOf(','));
                        //string dec = lblDeudaEbitda.Text.Substring(lblDeudaEbitda.Text.IndexOf(',') + 1, 2);
        ...
        /// <param name="objCliente"></param>
        /// <returns></returns>
        protected StringBuilder HTMLRolesHis(Cliente objCliente, string catCliente)
        {
            var nfi = new NumberFormatInfo();
            nfi.NumberDecimalSeparator = ",";
            nfi.NumberGroupSeparator = ".";
            ...
            html.AppendLine("                    </td> ");
            html.AppendLine("                    <td style=\"border-color:black;text-align:right;font-family: Verdana; color:black;vertical-align:middle;font-size: 7px\"> ");
            html.AppendLine("                        <label  >" + objCliente.saldoIPanama.Trim() + "</label> ");
            html.AppendLine("                    </td> ");
            // PMO19939 - RF061: Modificar visualización “Consulta Proceso Anteriores” del comité presencial
            html.AppendLine("                    <td style=\"border-color:black;text-align:right;font-family: Verdana; color:black;vertical-align:middle;font-size: 7px\"> ");
            html.AppendLine("                        <label  >" + objCliente.diasMoraPanama.Trim() + "</label> ");
